...
func SetupSlackApi() *slack.Client {
	appToken := os.Getenv("SLACK_APP_TOKEN")
	if appToken == "" || !strings.HasPrefix(appToken, "xapp-") {
		logger.Log(logger.Error, "Missing SLACK_APP_TOKEN with prefix \"xapp-\".")
	}

	botToken := os.Getenv("SLACK_BOT_TOKEN")
	if botToken == "" || !strings.HasPrefix(botToken, "xoxb-") {
		logger.Log(logger.Error, "Missing SLACK_BOT_TOKEN with prefix \"xoxb-\".")
	}
...
func RunSlack(api *slack.Client) {
